...
Sub Activity_Create(FirstTime As Boolean)
	...
	lblName.Text = "Myanmar Warso Font"
	lblName.TextSize = 13
	...
	lstOne.AddSingleLine2("App Name : Myanmar Warso Font",1)
...
Sub imv_Click
	StartActivity(p.OpenBrowser("http://www.myanmarandroidapp.com/search?q=Myanmar+Warso+Font"))
End Sub
