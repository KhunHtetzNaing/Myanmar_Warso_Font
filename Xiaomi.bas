...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","Warso.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/Warso.mtz")
	'	File.Copy(File.DirAssets,"Warso.mtz",File.DirRootExternal & "/MIUI/theme","Warso.mtz")
