package com.htetznaing.mmwarsofont;
...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmwarsofont", "com.htetznaing.mmwarsofont.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmwarsofont", "com.htetznaing.mmwarsofont.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmwarsofont.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmwarsofont.slidemenu _sm = null;
...
public com.htetznaing.mmwarsofont.main2 _main2 = null;
public com.htetznaing.mmwarsofont.samsung _samsung = null;
public com.htetznaing.mmwarsofont.oppo _oppo = null;
public com.htetznaing.mmwarsofont.huawei _huawei = null;
public com.htetznaing.mmwarsofont.vivo _vivo = null;
public com.htetznaing.mmwarsofont.tutorial _tutorial = null;
public com.htetznaing.mmwarsofont.about _about = null;
public com.htetznaing.mmwarsofont.xiaomi _xiaomi = null;
public com.htetznaing.mmwarsofont.other _other = null;
public com.htetznaing.mmwarsofont.msg _msg = null;
public com.htetznaing.mmwarsofont.msg1 _msg1 = null;
...
mostCurrent._imv.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 44;BA.debugLine="Activity.AddView(imv,50%x - 40dip,51dip,95dip,100";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._imv.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (51)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (95)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)));
...
mostCurrent._atx._initialize(mostCurrent.activityBA,"atx",main.getObject(),(int) (200));
 //BA.debugLineNum = 53;BA.debugLine="atx.Run( \" ♡  ဝါဆိုလ ဝါဆိုပြဲ ♡\" &CRLF& \"Myanmar";
mostCurrent._atx._run(" ♡  ဝါဆိုလ ဝါဆိုပြဲ ♡"+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Font Style",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lb.getObject())));
...
mostCurrent._lfoot.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 94;BA.debugLine="Activity.AddView(lfoot,0%x,(b4.Height+b4.Top)+1%y";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lfoot.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._b4.getHeight()+mostCurrent._b4.getTop())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 97;BA.debugLine="tlb.Initialize(\"tlb\")";
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 98;BA.debugLine="tlb.Text = \"Myanmar Warso Font\"";
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Myanmar Warso Font"));
 //BA.debugLineNum = 99;BA.debugLine="tlb.Color = Colors.rgb(205, 220, 57)";
mostCurrent._tlb.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (205),(int) (220),(int) (57)));
...
mostCurrent._tlb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 105;BA.debugLine="Activity.AddView(tlb,0%x,0%y,100%x,50dip)";
...
mostCurrent._menu.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 122;BA.debugLine="Activity.AddView(menu,10dip,10dip,30dip,30dip)";
...
mostCurrent._share.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 128;BA.debugLine="Activity.AddView(share,100%x - 40dip,10dip,30dip,";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._share.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 131;BA.debugLine="N.Initialize(\"N\",\"ca-app-pub-4173348573252986/982";
mostCurrent._n.Initialize(mostCurrent.activityBA,"N","ca-app-pub-4173348573252986/9828933353",(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (132))));
 //BA.debugLineNum = 132;BA.debugLine="N.LoadAd";
mostCurrent._n.LoadAd();
 //BA.debugLineNum = 133;BA.debugLine="Activity.AddView(N,0%x,100%y - 132dip,100%x,132di";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._n.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (132))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (132)));
 //BA.debugLineNum = 135;BA.debugLine="Interstitial.Initialize(\"Interstitial\",\"ca-app-pu";
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/6875466951");
 //BA.debugLineNum = 136;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 138;BA.debugLine="ad1.Initialize(\"ad1\",100)";
_ad1.Initialize(processBA,"ad1",(long) (100));
 //BA.debugLineNum = 139;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 140;BA.debugLine="ad2.Initialize(\"ad2\",60000)";
_ad2.Initialize(processBA,"ad2",(long) (60000));
 //BA.debugLineNum = 141;BA.debugLine="ad2.Enabled = True";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 217;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/MyanmarAndroidAp";
mostCurrent._ml.rmrf(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyanmarAndroidApps");
 //BA.debugLineNum = 218;BA.debugLine="Dim Answ As Int";
_answ = 0;
 //BA.debugLineNum = 219;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 220;BA.debugLine="Answ = Msgbox2(\"If you want to get new updates o";
_answ = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("If you want to get new updates on  Facebook? Please Like "+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Android Apps Page!"),BA.ObjectToCharSequence("Attention!"),"Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fb.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 221;BA.debugLine="If Answ = DialogResponse.NEGATIVE Then";
...
if (true) return anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 226;BA.debugLine="If Answ = DialogResponse.POSITIVE Then";
if (_answ==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 227;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 228;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 230;BA.debugLine="Try";
try { //BA.debugLineNum = 232;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 234;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb:/";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://page/627699334104477");
 //BA.debugLineNum = 235;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e19) {
			processBA.setLastException(e19); //BA.debugLineNum = 239;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 240;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook";
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 185;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();};
 //BA.debugLineNum = 186;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _b1_click() throws Exception{
 //BA.debugLineNum = 162;BA.debugLine="Sub b1_Click";
 //BA.debugLineNum = 163;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 164;BA.debugLine="StartActivity(Main2)";
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 167;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 168;BA.debugLine="StartActivity(Tutorial)";
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 172;BA.debugLine="StartActivity(About)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 175;BA.debugLine="Sub b4_Click";
 //BA.debugLineNum = 176;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.myanmaran";
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 144;BA.debugLine="Sub ft_Click";
 //BA.debugLineNum = 145;BA.debugLine="Try";
try { //BA.debugLineNum = 147;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 149;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb://";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://page/627699334104477");
 //BA.debugLineNum = 150;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 154;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 155;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook.";
_i.Initialize(_i.ACTION_VIEW,"https://m.facebook.com/MmFreeAndroidApps");
 //BA.debugLineNum = 157;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
...
mostCurrent._b4 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Wars";
mostCurrent._mm = new anywheresoftware.b4a.keywords.constants.TypefaceWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Wars";
mostCurrent._mm.setObject((android.graphics.Typeface)(mostCurrent._mm.LoadFromAssets("Warso.ttf")));
...
mostCurrent._lfoot = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim N As NativeExpressAd";
...
mostCurrent._sm = new com.htetznaing.mmwarsofont.slidemenu();
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub Interstitial_AdClosed";
...
public static String  _interstitial_adopened() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub Interstitial_adopened";
 //BA.debugLineNum = 204;BA.debugLine="Log(\"Opened\")";
...
public static String  _interstitial_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub Interstitial_FailedToReceiveAd (ErrorCode As S";
 //BA.debugLineNum = 199;BA.debugLine="Log(\"not Received - \" &\"Error Code: \"&ErrorCode)";
...
public static String  _interstitial_receivead() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub Interstitial_ReceiveAd";
 //BA.debugLineNum = 195;BA.debugLine="Log(\"Received\")";
anywheresoftware.b4a.keywords.Common.Log("Received");
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return "";
}
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 284;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 285;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
public static String  _n_adscreendismissed() throws Exception{
 //BA.debugLineNum = 310;BA.debugLine="Sub N_AdScreenDismissed";
 //BA.debugLineNum = 311;BA.debugLine="Log(\"N Dismissed\")";
...
public static String  _n_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 303;BA.debugLine="Sub N_FailedToReceiveAd (ErrorCode As String)";
 //BA.debugLineNum = 304;BA.debugLine="Log(\"N failed: \" & ErrorCode)";
anywheresoftware.b4a.keywords.Common.Log("N failed: "+_errorcode);
 //BA.debugLineNum = 305;BA.debugLine="End Sub";
return "";
}
public static String  _n_receivead() throws Exception{
 //BA.debugLineNum = 306;BA.debugLine="Sub N_ReceiveAd";
 //BA.debugLineNum = 307;BA.debugLine="Log(\"N received\")";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 288;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 289;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 290;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 291;BA.debugLine="copy.setText(\"#MyanmarWarsoFont App! Beautiful My";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarWarsoFont App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Warso+Font");
 //BA.debugLineNum = 292;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 293;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 294;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 295;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 296;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 297;BA.debugLine="StartActivity (ShareIt)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 269;BA.debugLine="copy.setText(\"#MyanmarWarsoFont App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarWarsoFont App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Warso+Font");
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 272;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 277;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 278;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.myanmar";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.myanmarandroidapp.com")));
 break; }
case 8: {
 //BA.debugLineNum = 280;BA.debugLine="StartActivity(About)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._about.getObject()));
 break; }
}
;
