...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmwarsofont", "com.htetznaing.mmwarsofont.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmwarsofont", "com.htetznaing.mmwarsofont.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmwarsofont.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 30;BA.debugLine="lb.Text = \"	Install ကိုနွိပ္ျပီး Myanmar Warso(iF";
mostCurrent._lb.setText(BA.ObjectToCharSequence("	Install ကိုနွိပ္ျပီး Myanmar Warso(iFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Warso(iFont) ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Samsung"));
 //BA.debugLineNum = 67;BA.debugLine="tlb.Color = Colors.rgb(205, 220, 57)";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 122;BA.debugLine="File.Copy(File.DirAssets,\"Warso.apk\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Warso.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk");
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Warso.apk");
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 131;BA.debugLine="If File.Exists(File.DirRootExternal,\"Warso.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 132;BA.debugLine="File.Delete(File.DirRootExternal,\"Warso.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk");
 };
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 147;BA.debugLine="If File.Exists(File.DirRootExternal,\"Warso.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 148;BA.debugLine="File.Delete(File.DirRootExternal,\"Warso.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk");
 };
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 229;BA.debugLine="copy.setText(\"#MyanmarWarsoFont App! Beautiful My";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 207;BA.debugLine="copy.setText(\"#MyanmarWarsoFont App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarWarsoFont App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Warso+Font");
