...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmwarsofont", "com.htetznaing.mmwarsofont.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmwarsofont", "com.htetznaing.mmwarsofont.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmwarsofont.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"Install ကိုနွိပ္ျပီး Myanmar Warso(iFo";
...
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Oppo"));
 //BA.debugLineNum = 66;BA.debugLine="tlb.Color = Colors.rgb(205, 220, 57)";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="File.Copy(File.DirAssets,\"Warso.apk\",File.DirRoot";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 130;BA.debugLine="If File.Exists(File.DirRootExternal,\"Warso.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="File.Delete(File.DirRootExternal,\"Warso.apk\")";
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="If File.Exists(File.DirRootExternal,\"Warso.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 147;BA.debugLine="File.Delete(File.DirRootExternal,\"Warso.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Warso.apk");
 };
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 228;BA.debugLine="copy.setText(\"#MyanmarWarsoFont App! Beautiful My";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 206;BA.debugLine="copy.setText(\"#MyanmarWarsoFont App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarWarsoFont App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Warso+Font");
