...
public class slidemenu extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.htetznaing.mmwarsofont.slidemenu");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.htetznaing.mmwarsofont.slidemenu.class).invoke(this, new Object[] {null});
        else
...
com.htetznaing.mmwarsofont.slidemenu._actionitem _item = null;
...
_item = new com.htetznaing.mmwarsofont.slidemenu._actionitem();
